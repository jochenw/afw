...
import com.github.jochenw.afw.rcm.impl.AbstractInstalledResourceRegistry.InstalledResource;


public class XmlFileResourceRegistryTest {
	@Test
	public void testRead() {
		final URL url = getClass().getResource("xml-resource-registry-test.xml");
