...
public interface IModule {
	...
	public interface LinkableBindingBuilder<T> extends ScopableBindingBuilder<T> {
		 ...
		 */
		public ScopableBindingBuilder<T> to(ISupplier<? extends @NonNull T> pSupplier);
		/** Sets the supplier of the created binding.
		 * @param pSupplier The supplier, which is being used.
		 * @return A binding builder for further configuration of the scope.
		 */
		public ScopableBindingBuilder<T> toSupplier(Supplier<? extends @NonNull T> pSupplier);
		 ...
		 * @return A binding builder for further configuration of the scope.
		 */
		public ScopableBindingBuilder<T> toClass(Class<? extends @NonNull T> pImplType);
		/** Creates a supplier for the binding, which is being registered.
		 ...
		 * @return A binding builder for further configuration of the scope.
		 */
		public ScopableBindingBuilder<T> toConstructor(Constructor<? extends @NonNull T> pConstructor);
		/** Creates a supplier for the binding, which is being registered.
		 ...
		 *   supplier.
		 */
		public default void toInstance(@NonNull T pInstance) {
